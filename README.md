...
<h4>This is a fullstack project, which consists of a simplistic UI, constructed of REACTJS (with the help of Material UI and Bootstrap), powered by a backend API constructed of NodeJS and finally MONGODB for the database. Full details of libraries and frameworks used can be found on the section below.
