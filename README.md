...
<h4>This is a fullstack project, which consists of - </br> a simplistic UI, constructed of REACTJS (with the help of Material UI and Bootstrap), </br> powered by a backend API constructed of NodeJS </br> and finally MONGODB for the database. </br> Full details of libraries and frameworks used can be found on the section below. </br>
